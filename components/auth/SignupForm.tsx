      ...
      <div className="relative hidden w-0 flex-1 lg:block">
        <div className="absolute inset-0 bg-gradient-to-br from-primary-600 to-primary-800 flex items-center justify-center">
          <div className="text-center text-white p-8">
            <h2 className="text-3xl font-bold mb-4">Join LifeLine Today!</h2>
            <p className="text-lg mb-6">
              Start protecting yourself and your family with our advanced
              accident detection system.
            </p>
            <div className="space-y-4">
              <div className="flex items-center justify-center space-x-2">
                <div className="h-2 w-2 bg-white rounded-full"></div>
                <span>Free Basic Protection</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <div className="h-2 w-2 bg-white rounded-full"></div>
                <span>2-Second Emergency Response</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <div className="h-2 w-2 bg-white rounded-full"></div>
              ...
              <div>
                ...
                <div className="mt-2 relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 px-3 pr-10"
